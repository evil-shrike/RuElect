...
namespace Elect.Loader.Support
{
	...
	/// </summary>
	public class Scroller : DependencyObject
	{
		public static readonly DependencyProperty AutoScrollToEndProperty 
			= DependencyProperty.RegisterAttached("AutoScrollToEnd", typeof(bool), typeof(Scroller), 
		...
		public static void OnAutoScrollToEndChanged(DependencyObject s, DependencyPropertyChangedEventArgs e)
		{
			...
			if (listBox == null)
				throw new InvalidOperationException("Присоединенное свойство AutoScrollToEnd может быть применено только к ListBox'у и его наследникам");
